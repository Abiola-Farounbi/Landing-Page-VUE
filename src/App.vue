  ...
  <main id="app">
    <section class='intro'>
     ...
     data-aos-delay='500' >
        ...
        <img  class='introImage' src='./assets/3d-illustration4.png' alt='3d illustration of boy with a flag'/>

    </section>

     <section class='guide1'>
       <img class='guide1Image' src='./assets/3d-illustration2.png' 
     ...
     <section class='guide2'>
      ...
      data-aos="slide-down"
        ...
        <img class='guide2Image' src='./assets/3d-illustration1.png' 
